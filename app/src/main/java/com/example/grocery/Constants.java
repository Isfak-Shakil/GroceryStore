...
public class Constants {
    // product categories
  public static final   String[] options={"Beverages","Personal Care",
            "Baby kids","Biscuits Snakes",
            "Breakfast & Dairy",
            "Cooking needs","Frozen food"
            ,"Fruits","Per cate","Pharmacy","Vegetables","others"
